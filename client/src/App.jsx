...
function App() {
  ...
  const collageImages = [
    { url: 'https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=500&q=80', span: 'tall' },
    { url: 'https://images.unsplash.com/photo-1552083375-1447ce886485?w=500&q=80', span: 'short' },
    { url: 'https://images.unsplash.com/photo-1516571748831-5d81767b788d?w=500&q=80', span: 'short' },
    { url: 'https://images.unsplash.com/photo-1533929736458-ca588d08c8be?w=500&q=80', span: 'tall' },
  ];
          ...
          <div style={styles.searchCard}>
            {activeTab === 'find' ? (
              <div style={styles.searchRow}>
                ...
                <button onClick={handleSwap} style={styles.swapBtn} aria-label="Swap stations">
                  ⇄
                </button>
          ...
          <div style={styles.recentCard}>
            ...
            {recentSearches.map((item) => (
              <div key={item.code} style={styles.recentRow}>
                ...
                <button style={styles.recentArrowBtn} aria-label={`Go to ${item.name}`}>
                  <ArrowIcon />
                </button>
              </div>
            ))}
...
const styles = {
  ...
  searchCard: {
    ...
    borderRadius: 24,
    padding: 12,
    boxShadow: '0 12px 32px rgba(30, 41, 59, 0.07)',
  ...
  recentCard: {
    ...
    marginTop: 18,
    border: `1px solid ${colors.border}`,
    boxShadow: '0 6px 18px rgba(30, 41, 59, 0.04)',
  },
  recentHeader: {
    fontSize: 12,
    fontWeight: 700,
